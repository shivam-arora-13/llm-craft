...
class Popover extends Component {
  ...
  handleAvatarListItemClick = (e, i, src) => {
    if (i !== 0) {
  ...
  getAvatar = ({ src, label }, i) => (
    <li
      ...
      style={{ outline: "none" }}
      onClick={e => this.handleAvatarListItemClick(e, i, src)}
      onKeyPress={this.handleEnterKeyPress(e =>
        this.handleAvatarListItemClick(e, i, src)
      )}
      tabIndex={0}
    >
  ...
  render() {
    const { avatarList, scaleOutClass, onChange } = this.props;
    return (
